...
<head>
	...
	<link href="/jmiconnect/assets/css/bootstrap.min.css" rel="stylesheet">
	<link href="/jmiconnect/assets/css/welcome.css" rel="stylesheet">
</head>
<body>
	<header class="header">
		<div class="text-vertical-center">
			...
			<form role="form" method="post" action="/jmiconnect/user/login">

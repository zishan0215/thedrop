        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-8 col-md-offset-2">
                  <form method="post" action="/thedrop/index.php/admin/update_action">
                    <table class="table">
                      <tr>
                        <th>Complaint Id</th>
                      ...
                      <tr>
                        <th>Authority</th>
                        <td><input type="text" name="authority" value="<?php echo $complaint->authority ?>"></td>
                      </tr>
                      <tr></tr>
                      <tr>
                        <th>Status</th>
